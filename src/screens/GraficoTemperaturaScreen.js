// Tela Grafico de Temperatura — placeholder temporario
// Exibira o grafico de temperatura do cimento em tempo real
...
export default function GraficoTemperaturaScreen({ navigation, route }) {
  ...
  return (
    ...
    >
      ...
      {/* Icone ilustrativo */}
      <Ionicons name="thermometer-outline" size={72} color="rgba(255,255,255,0.25)" style={styles.icone} />
