// Tela Financeiro — placeholder temporario
// Exibira o controle financeiro da obra (custos, pagamentos, saldo)
...
export default function FinanceiroScreen({ navigation, route }) {
  ...
  return (
    ...
    >
      ...
      {/* Icone ilustrativo */}
      <MaterialCommunityIcons name="currency-usd" size={72} color="rgba(255,255,255,0.25)" style={styles.icone} />
