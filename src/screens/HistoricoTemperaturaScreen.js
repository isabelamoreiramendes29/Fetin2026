// Tela Historico de Temperatura — placeholder temporario
// Exibira o historico de temperaturas registradas da obra
...
export default function HistoricoTemperaturaScreen({ navigation, route }) {
  ...
  return (
    ...
    >
      ...
      {/* Icone ilustrativo */}
      <MaterialCommunityIcons name="chart-line" size={72} color="rgba(255,255,255,0.25)" style={styles.icone} />
