// Tela Rastrear Caminhoes — placeholder temporario
// Acessada pelo card "Rastrear Caminhões" do MenuConstrutoraScreen
...
export default function RastrearCaminhoesScreen({ navigation }) {
  return (
    <LinearGradient
    ...
    >
      ...
      <Text style={styles.titulo}>Rastrear Caminhões</Text>
